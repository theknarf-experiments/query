//! JSON value type with Chumsky-based parser
//!
//! This crate provides a `JsonValue` type for representing JSON data,
//! along with parsing, serialization, and path extraction capabilities.
